...
수현 : 여러모로 많은 배움을 얻었던 주였습니다. 페어인 혜린님을 통해 코딩 습관을 옆에서 배울 수도 있었고, 여러모로 가르침을 많이 받았던 것 같습니다.
항상 DI는 여러번 보고 정리해도 부족한 것 같았는데 이번에 다시 한번 정리하게 되어 이해하는데 도움이 되었습니다 CONTEXT API부분은 생소하게 다가왔기에 좋은 공부가 되었습니다.
REACT-HOOK-FORM은 왜 이런거 이제 알았지 하는 느낌이었고, 스파게티 코드를 리팩토링 하는 것은 앞으로 코딩 습관에 대해 많은 영향을 끼칠 것 같습니다!
혜린님도 이번주 수고하셨어요 ㅎㅎ
